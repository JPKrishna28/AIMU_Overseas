          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            {WHY_CARDS.map((card, index) => (
              <Reveal key={card.title} delay={index * 90}>
                <div className="h-full rounded-xl border border-navy/10 bg-white p-10 text-center shadow-[0_10px_30px_-10px_rgba(13,28,50,0.1)] transition-all duration-300 hover:-translate-y-2 hover:shadow-lg">
